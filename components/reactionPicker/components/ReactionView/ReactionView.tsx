...
const ReactionView = forwardRef<ReactionRefType, ReactionViewProps>(
    (props: ReactionViewProps, ref) => {
        const {
            children,
            touchableProps,
            itemIndex = 0,
        ...
        const isCardOpen: boolean = mainViewX > 0 && showPopUpCard;
...
ReactionView.displayName = 'ReactionView';
